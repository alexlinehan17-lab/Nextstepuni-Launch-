  ...
  'history': {
    ...
    sections: [
      // Section 1 — Exam Structure
      {
        ...
        paragraphs: [
          'Leaving Certificate History Higher Level has two assessment components. The **Research Study Report (RSR)** is a coursework project worth **100 marks — 20%** of your final grade, completed before the exam. The **written examination** is a single paper lasting **2 hours and 50 minutes**, worth **400 marks — 80%** of your grade. Together they total 500 marks. This module focuses on the written paper, where the larger share of your grade is decided, so understanding its layout is critical.',
      ...
      // Section 3 — High-Value Zones
      {
        ...
        paragraphs: [
          'The [[Document Question]] is the single highest-value opportunity on the entire paper. It is worth **100 marks** — a quarter of the written paper (and 20% of your overall grade) — and it is the most accessible section because **the answers are in the documents in front of you**. You do not need to recall facts from memory; you need to read carefully and respond to what is on the page. Students who prepare well for the Document Question format can score 80+ marks here relatively comfortably.',
          'Within the Document Question, the **contextualisation** sub-question (worth **40 marks** — the largest single part of the Document Question) asks you to write a developed mini-essay setting the documents in their historical context. This is the one part where you do need memorised knowledge, so prepare the context for each topic you study. The **comprehension** and **comparison** questions (20 marks each) are the easiest marks on the paper — they literally ask you to find information in the sources and compare what two documents say.',
