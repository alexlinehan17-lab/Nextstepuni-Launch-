...
const decks = [
  ...
  ['economics:higher', ECON_HIGHER, 166, 'baf2acd47d59a4e3b3e757210505aa9c3eb648d7f6a095d503a5a3bcfb001208'],
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(4_959);
  });
});
