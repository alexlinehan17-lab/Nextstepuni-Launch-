...
const decks = [
  ...
  ['home-economics:ordinary', HOME_EC_ORDINARY, 183, 'f211052d028dcdb485748144bf1d6ec6202334b2360f9970de7aa7296799d209'],
] as const;
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(4_413);
  });
});
