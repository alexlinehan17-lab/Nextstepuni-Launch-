...
const decks = [
  ...
  ['economics:higher', ECON_HIGHER, 233, '24f5d1299ae954cd78590c87c1cf290c9b4211f17dc09f5aea48797c100a735d'],
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(5_176);
  });
});
