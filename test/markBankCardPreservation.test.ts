...
const decks = [
  ...
  ['economics:ordinary', ECON_ORDINARY, 139, 'fd6621afc06cd2d39df92f0b775834500220772b4963544a3a6ca4f2d6986641'],
] as const;
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(5_143);
  });
});
