...
const decks = [
   ...
   * remain. */
  /* 2026-08-29 (second wave): economics 303/247 -> 314/249. Thirteen cards
  ...
  ['economics:ordinary', ECON_ORDINARY, 249, 'b4f07c165c5f6d9d9368fc9a8232faee27ac686561e073026ab0e699d829b53a'],
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(7235);
  });
});
