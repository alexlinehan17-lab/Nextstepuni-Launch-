...
const decks = [
  ...
  ['home-economics:higher', HOME_EC_HIGHER, 228, '480d36bdfadea3455b7c6c9d176c2ad38ef8678d6edd825cbf18fb6caa1a33a7'],
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(4_439);
  });
});
