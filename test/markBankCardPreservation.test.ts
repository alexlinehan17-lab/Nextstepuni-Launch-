...
const decks = [
  ...
  ['home-economics:ordinary', HOME_EC_ORDINARY, 194, '503bfc30909e398f6243173941fec61120a592668070c6eaaae56120b2dd2673'],
] as const;
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(4_424);
  });
});
