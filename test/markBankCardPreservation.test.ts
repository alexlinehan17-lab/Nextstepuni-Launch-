...
const decks = [
  ...
  ['business:ordinary', BUSINESS_ORDINARY, 331, '665722aeee4255ee32ee37533fb9aeb84cb5b22e47e0aa527f34fd61d95fcc00'],
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(5_228);
  });
});
