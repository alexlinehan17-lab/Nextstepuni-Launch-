...
const decks = [
  ...
  ['physics:higher', PHYS_HIGHER, 475, 'a6e0ad3cbd372f87096c7dd8276830a6d11f3dd3937cfb3bbcfa7627534077b9'],
  ['physics:ordinary', PHYS_ORDINARY, 474, 'bde7230d18b45764e1ebab2ecca6db8b820c40ebc0080f96cae93c0dbd96062c'],
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(5_382);
  });
});
