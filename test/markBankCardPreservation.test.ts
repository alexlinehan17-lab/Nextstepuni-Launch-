...
const decks = [
  ...
  ['physics:higher', PHYS_HIGHER, 451, '76265eb757959d9b9847d1bafacb1145de0bc9a94c2103fa6feeed853b1078ee'],
...
describe('Mark Bank card preservation', () => {
  ...
  it('protects the complete current bank', () => {
    expect(decks.reduce((total, [, cards]) => total + cards.length, 0)).toBe(5_336);
  });
});
