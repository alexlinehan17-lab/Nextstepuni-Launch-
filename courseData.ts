...
const COURSE_DEFINITIONS = [
  ...
  },
  {
    ...
    description: 'Navigate the Computer Science exam and coursework — understand the coursework project, the computer-based exam, and how to maximise marks across both.',
    sectionsCount: 6,
    curriculum: 'both' as const,
    jcStatus: 'coming-soon' as const,
    tags: ['Subject Strategy', 'Exam Tactics'],
  },
  {
    ...
    description: 'Crack the Agricultural Science exam — from the Individual Investigative Study and experiments to the written paper — and learn what the examiner rewards.',
    sectionsCount: 6,
    curriculum: 'both' as const,
    jcStatus: 'coming-soon' as const,
    tags: ['Subject Strategy', 'Exam Tactics'],
