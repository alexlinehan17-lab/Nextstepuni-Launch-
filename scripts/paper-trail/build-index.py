...
QA_PASSED_ANSWER_PROFILES = {
    ...
    ('italian', 'higher', 'ev'),
    ('italian', 'ordinary', 'ev'),
    ('jc-applied-technology', 'common', 'ev'),
    ('jc-applied-technology', 'common', 'iv'),
    ('jc-business-studies', 'common', 'iv'),
    ('jc-classics', 'common', 'ev'),
    ('jc-classics', 'common', 'iv'),
    ('jc-engineering', 'common', 'ev'),
    ('jc-engineering', 'common', 'iv'),
    ('jc-geography', 'common', 'iv'),
    ('jc-german', 'common', 'ev'),
    ('jc-german', 'common', 'iv'),
    ('jc-home-economics', 'common', 'iv'),
    ('jc-irish-t1', 'higher', 'iv'),
    ('jc-irish-t1', 'ordinary', 'iv'),
    ('jc-music', 'common', 'iv'),
    ('jc-religious-education', 'common', 'iv'),
    ('jc-spanish', 'common', 'ev'),
    ('jc-spanish', 'common', 'iv'),
    ('jc-wood-technology', 'common', 'iv'),
    ('lca-active-leisure-studies', 'common', 'ev'),
    ('lca-graphics-and-construction-studies', 'common', 'ev'),
    ('lca-mathematical-applications', 'common', 'ev'),
    ('lca-social-education', 'common', 'ev'),
    ('lca-technology', 'common', 'ev'),
    ('music', 'higher', 'ev'),
    ('spanish', 'ordinary', 'ev'),
    ('accounting', 'ordinary', 'iv'),
    ('agricultural-economics', 'higher', 'iv'),
    ('agricultural-economics', 'ordinary', 'iv'),
    ('agricultural-science', 'ordinary', 'iv'),
    ('applied-mathematics', 'higher', 'iv'),
    ('applied-mathematics', 'ordinary', 'iv'),
    ('biology', 'higher', 'iv'),
    ('business', 'higher', 'iv'),
    ...
    ('computer-science', 'ordinary', 'iv'),
    ('economics', 'higher', 'iv'),
    ('economics', 'ordinary', 'iv'),
    ('engineering', 'higher', 'iv'),
    ('engineering', 'ordinary', 'iv'),
    ('geography', 'higher', 'iv'),
    ...
    ('italian', 'ordinary', 'iv'),
    ('latin', 'ordinary', 'iv'),
    ('physical-education', 'higher', 'iv'),
    ('physical-education', 'ordinary', 'iv'),
    ('physics', 'higher', 'iv'),
    ('physics-and-chemistry', 'higher', 'iv'),
    ('spanish', 'ordinary', 'iv'),
    ('technology', 'higher', 'iv'),
    ('technology', 'ordinary', 'iv'),
    ...
    ('applied-mathematics', 'higher', 'ev'),
    ('applied-mathematics', 'ordinary', 'ev'),
    ...
    ('engineering', 'higher', 'ev'),
    ('engineering', 'ordinary', 'ev'),
    ('english', 'higher', 'ev'),
    ('finnish', 'higher', 'ev'),
    ('geography', 'higher', 'ev'),
    ('geography', 'ordinary', 'ev'),
    ('history', 'higher', 'ev'),
    ('home-economics-s-and-s', 'higher', 'ev'),
    ('home-economics-s-and-s', 'ordinary', 'ev'),
    ('hungarian', 'higher', 'ev'),
