#!/usr/bin/env python3
"""Assemble Agricultural Science cards from the paper and the scheme.
...
def part_id(year, level, q, letter=None, roman=None, suffix=''):
    return (f'agsci-{year}-{level}-q{q}' + (letter or '') + (roman or '')
