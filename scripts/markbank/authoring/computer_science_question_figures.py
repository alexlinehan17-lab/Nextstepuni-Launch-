...
"""Crop the code a Computer Science question prints, so its asks can be carded.
    ...
    python3 scripts/markbank/authoring/computer_science_question_figures.py 2024 hl 2
    python3 scripts/markbank/authoring/computer_science_question_figures.py --write
    python3 scripts/markbank/authoring/computer_science_question_figures.py --catalogue
