...
# Not carded here: chem-2024-hl-q3-b-iii is already a shipped hand-authored card.
# merge.py refuses the collision, and it is right to — a script must not
# quietly replace verified content.

# Not carded here: chem-2024-hl-q5-b-vi is already a shipped hand-authored card.
# merge.py refuses the collision, and it is right to — a script must not
# quietly replace verified content.

# Not carded here: chem-2024-hl-q8-a is already a shipped hand-authored card.
# merge.py refuses the collision, and it is right to — a script must not
# quietly replace verified content.
