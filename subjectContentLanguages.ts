    ...
    sections: [
      // Section 1 — Exam Structure
      {
        ...
        paragraphs: [
          ...
          'Paper 1 is your [[Composing and Comprehension]] paper. It runs for **2 hours 50 minutes** and is worth **200 marks**. You face two sections: Section I — Comprehending (**100 marks**), which presents three texts on a shared theme — you answer a **Question A (50 marks, comprehension) on one text and a Question B (50 marks, a functional writing task) on a different text** (you may not answer both on the same text) — and Section II is the Composition where you choose one essay from a list of prompts (100 marks). The composition prompts relate to the same theme as the texts.{{cite:1}}',
          '[[Paper 2]] is the literature paper, also **200 marks** and **3 hours 20 minutes** long. It has three sections: the [[Single Text]] (one of your studied plays or novels — 60 marks), the [[Comparative Study]] (comparing three texts through one mode of comparison — 70 marks; in 2025 the modes were Theme or Issue, Cultural Context, and General Vision and Viewpoint), and [[Poetry]] (**70 marks** total, in two parts: an **Unseen Poem** you have never seen before — 20 marks — and **Prescribed Poetry**, an essay on one of your studied poets — 50 marks).{{cite:1}}',
        ...
        highlights: [
          ...
          { term: 'Single Text', description: 'One text studied in depth — a play (e.g. Hamlet, Philadelphia Here I Come!) or a novel. You answer one question from a choice of options. Worth 60 marks.' },
          { term: 'Comparative Study', description: 'You compare three texts across one mode of comparison. In the exam you answer one question, drawing on at least two of your texts (some questions require all three). Worth 70 marks — and in the Chief Examiner\'s Report it was the section where candidates scored least well, so real comparative technique here is a genuine edge.' },
      ...
      // Section 2 — Marking Criteria
      {
        ...
        paragraphs: [
          'Every answer you write in Leaving Cert English is assessed using the [[PCLM]] framework. This stands for **Purpose**, **Coherence of Delivery**, **Language**, and **Mechanics**. Understanding PCLM is not optional — it is literally the lens through which every examiner reads your work. The published split is **Purpose 30%, Coherence 30%, Language 30%, Mechanics 10%** — so the first three criteria dominate, and Purpose has primacy (the marks for Coherence or Language can never exceed the marks awarded for Purpose).{{cite:1}} Together they define the difference between an H5 and an H1.',
          '**Purpose** means you actually answer the question asked. Sounds obvious, but a beautiful answer to a question that was not asked does not fulfil the task. The examiner checks: did the student understand the task? Did they sustain their focus throughout? In a composition, this means your essay must match the genre (if the prompt asks for a speech, it must sound like a speech). In Paper 2, it means directly engaging with the specific question, not dumping everything you know about a text.{{cite:1}}',
          '**Coherence of Delivery** is about [[structure and flow]] — the scheme describes it as the ability to sustain the response over the entire answer: continuity of argument, sequencing, management of ideas, choice of reference.{{cite:1}} Does your answer have a clear arc? Do your paragraphs connect logically? Is there a sense of development from start to finish? Top-scoring students plan before they write, and their answers feel like they are going somewhere, not just listing points.',
          'The **Language** criterion rewards vocabulary, syntax and phrasing that achieve clear communication — the scheme\'s own descriptors include "lively interesting phrasing, energy, style".{{cite:1}} The examiner is looking for writing that sounds like it belongs to you — not regurgitated teacher-notes or formulaic phrases. **Mechanics** covers spelling and grammar.{{cite:1}} It carries only 10% of each answer, so it will not sink a strong response on its own — but consistent errors still cost the marks that are there, and it is the easiest 10% to protect. Proofread. Every. Time.'
        ],
        highlights: [
      ...
      // Section 3 — High-Value Zones
      {
        ...
        highlights: [
          ...
          { term: 'Comparative Study', description: 'Worth 70 marks on Paper 2, and the section where candidates scored least well in the Chief Examiner\'s Report, which warns that rigid, formulaic approaches hamper candidates. Build real comparative skill and choose your evidence well — don\'t recite a script.' },
      ...
      // Section 4 — Common Pitfalls
      {
        ...
        paragraphs: [
          'A mark-killer you will meet all over English is [[not answering the question]]. This shows up everywhere: compositions that drift off-topic, Single Text answers that retell the plot instead of addressing the question, and Comparative answers that discuss each text separately instead of comparing. The Chief Examiner\'s Report puts it plainly: "The best answers managed to remain grounded, both in the question asked and in the text", while under-achievement in the Comparative "could often be attributed to a loss of focus in terms of the requirements of the task".{{cite:2}} Write the question at the top of your page and refer back to it every two paragraphs.',
          'Another killer is **running out of time**. Paper 2 is 3 hours and 20 minutes for three sections. If you spend 80 minutes on the Single Text, you are stealing time from the Comparative and the Poetry section — both of which are worth more marks. The Chief Examiner\'s Report is blunt: "Omitting questions or parts of questions inevitably has a deleterious effect on outcomes" — and where candidates left sections unfinished, "inefficient time management may have been a factor".{{cite:2}} Stick to a strict time plan: roughly 55 minutes for the Single Text (60 marks), 70 minutes for the Comparative (70 marks), and 70 minutes for Poetry (70 marks) — split within Poetry so the 50-mark Prescribed essay gets the lion\'s share and the 20-mark Unseen Poem takes about 20 minutes.',
          'On Paper 1, some students [[under-develop their composition]]. In the Chief Examiner\'s Report, examiners flag compositions that were "extremely brief and lacked development", noting that "it is difficult to sustain a response or develop a range of ideas necessary to acquire maximum marks if the answer is brief in the extreme" — while the strongest writers showed real command of their chosen genre: in a short story, for instance, narrative shape, characterisation, setting and atmosphere.{{cite:2}} Short compositions signal that you either ran out of ideas or ran out of time, and neither is forgiven.',
          'Finally, many students write in a generic, impersonal voice that sounds like it could belong to anyone. The Language criterion explicitly rewards "lively interesting phrasing, energy, style" appropriate to the task — writing that sounds like a real person with real thoughts.{{cite:1}} Ditch the clichés. Stop starting paragraphs with "Furthermore" and "Moreover". Write in your own voice and the examiner will notice.'
        ],
        highlights: [
          { term: 'not answering the question', description: 'A recurring cause of lost marks in the Chief Examiner\'s Report. Always re-read the question before starting each paragraph. If your paragraph does not directly address the question, cut it or rewrite it.' },
          { term: 'under-develop their composition', description: 'Top-scoring compositions are sustained pieces of writing, rich in detail and developed thought. In the examiners\' words, it is difficult to develop the range of ideas needed for maximum marks "if the answer is brief in the extreme".' }
        ],
      },
