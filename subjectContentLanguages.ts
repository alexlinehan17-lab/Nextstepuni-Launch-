...
import { SUBJECT_ENGLISH_REFERENCE_LIST } from './data/references/subjectEnglish';
  ...
  english: {
    ...
    sections: [
      // Section 1 — Exam Structure
      {
        ...
        paragraphs: [
          'Leaving Cert English is assessed entirely through two written papers worth a combined **400 marks**.{{cite:1}} There is no oral, no coursework, no project — just you and two exam booklets across two days. That simplicity is actually a gift: every mark is within your control on the day.',
          'Paper 1 is your [[Composing and Comprehension]] paper, worth **200 marks** over **2 hours 50 minutes**. Section I — Comprehending — is worth **100 marks**: a Question A (50 marks, reading comprehension on one text) and a Question B (50 marks, a short functional writing task) — and you may not answer A and B on the same text.{{cite:1}} Section II is the Composition: one essay chosen from the list of prompts, worth **100 marks**. The whole paper is built around a single theme, and you are free to refer to, quote from, or draw ideas from any of the paper\'s texts in your composition.{{cite:1}}',
          '[[Paper 2]] is the literature paper, also **200 marks**, over **3 hours 20 minutes**. It has three sections: the [[Single Text]] (one of your studied texts — 60 marks), the [[Comparative Study]] (comparing your comparative texts through one mode of comparison — 70 marks; in 2025 the modes were Theme or Issue, Cultural Context, and General Vision and Viewpoint), and [[Poetry]] (70 marks) — which is **not** all unseen: it pairs a short Unseen Poem question (20 marks) with Prescribed Poetry on your studied poets (50 marks), and both parts are compulsory.{{cite:1}}',
          'The total weighting is perfectly balanced: 50% for personal writing and comprehension skills (Paper 1), and 50% for literature response (Paper 2).{{cite:1}} Understanding this split is your first strategic advantage — neglect either paper and you cap your grade.'
        ],
        highlights: [
          ...
          { term: 'Single Text', description: 'One text studied in depth — a play (e.g. Hamlet, Philadelphia Here I Come!) or a novel. You answer one question. Worth 60 marks.' },
          { term: 'Comparative Study', description: 'You compare the texts you studied for this section through one mode of comparison. Worth 70 marks. The Chief Examiner\'s Report found it was the section where candidates scored least well — so real comparative technique here is a genuine edge.' },
          { term: 'Poetry', description: 'Section III of Paper 2, worth 70 marks in two compulsory parts: an Unseen Poem question (20 marks) and Prescribed Poetry on your studied poets (50 marks). Skipping the unseen poem throws away up to 20 marks.' }
        ],
      },
      // Section 2 — Marking Criteria
      {
        ...
        paragraphs: [
          'Every answer you write in Leaving Cert English is assessed against the [[PCLM]] criteria: **Clarity of Purpose**, **Coherence of Delivery**, **Efficiency of Language Use**, and **Accuracy of Mechanics**. Understanding PCLM is not optional — it is literally the lens through which every examiner reads your work. The weighting for every task is 30% Purpose, 30% Coherence, 30% Language, and 10% Mechanics.{{cite:1}}',
          '**Clarity of Purpose** means you actually answer the question asked. Sounds obvious, but the examiner checks: did the student understand the task? Did they sustain their focus throughout? In a composition, this means your essay must match the genre (if the prompt asks for a speech, it must sound like a speech). In Paper 2, it means directly engaging with the specific question, not dumping everything you know about a text. And Purpose has a special status in the scheme: marks for Coherence or Language can never exceed your Purpose mark — an answer that misses the point is capped everywhere else too.{{cite:1}}',
          '**Coherence of Delivery** is about [[structure and flow]] — the scheme describes it as sustaining the response over the entire answer: continuity of argument, sequencing, management of ideas, choice of reference.{{cite:1}} Does your answer have a clear arc? Do your paragraphs connect logically? Top-scoring students plan before they write, and their answers feel like they are going somewhere, not just listing points.',
          'The **Language** criterion rewards vocabulary, syntax and phrasing that achieve clear communication — the scheme\'s own words include "lively interesting phrasing, energy, style".{{cite:1}} The examiner is looking for writing that sounds like it belongs to you — not regurgitated teacher-notes or formulaic phrases. **Mechanics** covers spelling and grammar. It is the smallest slice at 10%, but consistent errors still drag a script down.{{cite:1}} Proofread. Every. Time.'
        ],
        highlights: [
          { term: 'PCLM', description: 'Clarity of Purpose, Coherence of Delivery, Efficiency of Language Use, Accuracy of Mechanics — weighted 30/30/30/10 for every task on both papers. Purpose has primacy: the Coherence and Language marks can never exceed the Purpose mark.' },
      ...
      // Section 3 — High-Value Zones
      {
        ...
        paragraphs: [
          'The single biggest mark allocation in English is the [[Paper 1 Composition]] at **100 marks** — that is 25% of your entire grade in one answer.{{cite:1}} Nothing else in the exam comes close. If you write one exceptional essay, you have secured a quarter of your total. This is where strong students separate themselves: they practise compositions across multiple genres (personal essay, short story, speech, article, debate) and go into the exam with a flexible toolkit of ideas, not a pre-learned script.',
          'On Paper 2, the [[Comparative Study]] (70 marks) and the Poetry section (70 marks) together make up 35% of your total.{{cite:1}} But beware the "learn a formula" myth about the Comparative: the Chief Examiner\'s Report found it was the section where candidates scored least well, and warns that formulaic approaches "can hinder candidates by inhibiting their engagement with the terms of the questions".{{cite:2}} What actually scores is engaging with the question asked and the evidence you choose — the report calls the quality of evidence cited "a significant discriminator used by examiners".{{cite:2}}',
          'The [[Unseen Poem]] is worth 20 of the Poetry section\'s 70 marks, and it punches above its weight: it was the lowest-scoring element of Paper 2 in the Chief Examiner\'s data, and some candidates skipped this compulsory question entirely, losing up to twenty marks.{{cite:2}} You **cannot study the specific poem** — the playing field is level, and a student who has practised responding to unseen poems will outperform one who relies only on studied poets. The remaining 50 marks are [[Prescribed Poetry]] on your studied poets, where the examiner praises candidates who can "link and cross reference" a poet\'s work rather than deliver a formula.{{cite:2}}',
          'Section I of Paper 1 delivers **100 marks**: Question A tests careful reading of one text, and Question B is a short functional writing task on a different text.{{cite:1}} Many students treat this section as warm-up, but it is worth the same as the composition. Read each text twice, watch for nuance — the examiner warns against "an overly literal interpretation of language" — and give Question B\'s format (letters, reports, speeches) the attention its 50 marks deserve.{{cite:2}}'
        ],
        highlights: [
          ...
          { term: 'Comparative Study', description: 'Worth 70 marks on Paper 2, and the lowest-scoring section in the Chief Examiner\'s data — not because it is impossible, but because rigid formulas inhibit real engagement with the question. Build comparative skill and choose evidence well; don\'t recite a script.' },
          { term: 'Unseen Poem', description: 'Worth 20 marks, compulsory, and historically the lowest-scoring element of Paper 2. You cannot memorise your way through it — weekly practice on past-paper poems is the best preparation.' },
          { term: 'Prescribed Poetry', description: 'Worth 50 marks. Know your studied poets well enough to link and cross-reference their poems in answer to the specific question — flexible knowledge beats a pre-learned essay.' }
        ],
      },
      // Section 4 — Common Pitfalls
      {
        ...
        paragraphs: [
          'The biggest mark-killer in English is [[not answering the question]]. This shows up everywhere: compositions that drift off-topic, Single Text answers that retell the plot instead of addressing the question, and Comparative answers that discuss each text separately instead of comparing. The Chief Examiner\'s Report ties under-achievement to "a loss of focus in terms of the requirements of the task", and notes that prepared "banks of knowledge" earn marks only when shaped to the specific question asked.{{cite:2}} Write the question at the top of your page and refer back to it every two paragraphs.',
          'The second killer is **running out of time**. Paper 2 is 3 hours and 20 minutes for three full sections. If you spend 80 minutes on the Single Text, you are stealing time from the Comparative and the Poetry section — both of which are worth more marks. The examiner is blunt about the consequence: "Omitting questions or parts of questions inevitably has a deleterious effect on outcomes", with inefficient time management a likely factor.{{cite:2}} Stick to a strict time plan — for example, roughly 55 minutes for the Single Text and 70 each for the Comparative and Poetry.',
          'On Paper 1, students routinely [[under-develop their composition]]. The Chief Examiner\'s words: "it is difficult to sustain a response or develop a range of ideas necessary to acquire maximum marks if the answer is brief in the extreme" — and the strongest compositions showed real command of their chosen genre: narrative shape, characterisation, setting and atmosphere in a story, and the conventions of whatever form you choose.{{cite:2}} Short compositions signal that you either ran out of ideas or ran out of time, and neither is forgiven.',
          'Finally, many students write in a generic, impersonal voice that sounds like it could belong to anyone. The Language criterion explicitly rewards "lively interesting phrasing", energy and style appropriate to the task — writing that sounds like a real person with real thoughts.{{cite:1}} Ditch the clichés. Stop starting paragraphs with "Furthermore" and "Moreover". Write in your own voice and the examiner will notice.'
        ],
        highlights: [
          { term: 'not answering the question', description: 'A leading cause of mid-range marks across all of English. Always re-read the question before starting each paragraph. If your paragraph does not directly address the question, cut it or rewrite it.' },
          { term: 'under-develop their composition', description: 'Top-scoring compositions are sustained pieces of writing, rich in detail and developed thought. In the examiner\'s words, it is difficult to develop the necessary range of ideas "if the answer is brief in the extreme".' }
        ],
      },
      // Section 5 — Study Techniques
      {
        ...
        paragraphs: [
          ...
          'For Paper 2, create a [[one-page summary]] for each of your studied texts: key themes, important quotes (aim for five to eight per text), and character arcs. For the Comparative, build a comparison grid — a table with your comparative texts across the top and key aspects of the mode down the side. Fill in each cell with a specific reference. This grid forces you to think comparatively before you walk into the exam — but treat it as raw material, not a script: the examiner explicitly warns that formulaic, pre-fabricated answers hinder engagement with the question.{{cite:2}}',
          'For the Unseen Poem, build a consistent reading routine: what is literally happening; the tone or attitude, and where it shifts; the imagery and sound of the language; and what the poem suggests rather than states. That routine mirrors exactly what examiners are told to reward — "the patterned nature of the language of poetry, its imagery, its sensuous qualities, and its suggestiveness" — and they are warned against assuming a single "correct" reading, so a well-argued personal response is safe ground.{{cite:1}} Work through one unseen poem per week and you will approach any poem with confidence. Past papers are your best resource — every year is free in Paper Trail.'
        ],
        highlights: [
      ...
      // Section 6 — Action Plan
      {
        ...
        highlights: [
          { term: 'PCLM', description: 'Use the PCLM criteria to self-assess: Was my Purpose clear — did I answer the question asked? Was my Delivery coherent from start to finish? Was my Language efficient and alive? Were my Mechanics clean? Remember the weighting: 30/30/30/10.' }
        ],
