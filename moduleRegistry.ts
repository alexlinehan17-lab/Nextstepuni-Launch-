...
export const moduleComponents: { [key: string]: ModuleComponent } = {
  ...
  'marking-scheme-decoder-protocol': lazy(() => import('./components/MarkingSchemeDecoderModule')),
  'answer-engineering-protocol': lazy(() => import('./components/AnswerEngineeringModule')),
