...
// criteria descriptors in Appendix 1, the unseen-poetry marking stance) and the
// in-repo 2013 English Chief Examiner's Report, the most recent for LC English
// (section averages, formulaic comparative answers, loss of task focus, brief
// undeveloped compositions, genre and register, omissions and timing). The 2024
// HL scheme was used as a second-year stability check
// (examiner-reports/english/2024-verification.md).
