...
const RawQuestionStage: React.FC<Props> = ({ question, onPredictStart }) => (
  <div className="space-y-6">
    ...
    <div className="flex flex-col items-center gap-2 pt-2">
      ...
      <p className="font-sans" style={{ fontSize: 12, color: '#A8A29E' }}>
        A few quick prompts about the question itself — then we reveal the examiner's notes.
      </p>
    </div>
  </div>
);
...
export default RawQuestionStage;
