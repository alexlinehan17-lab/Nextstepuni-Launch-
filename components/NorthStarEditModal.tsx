            ...
            <div className="relative overflow-hidden rounded-t-2xl bg-gradient-to-br from-[rgba(var(--accent),0.2)] via-amber-400/10 to-transparent px-6 pt-6 pb-8">
              ...
              <div className="flex items-center gap-3">
                <MotionDiv
                  ...
                  className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-400 to-[var(--accent-hex)] flex items-center justify-center shadow-lg shadow-amber-400/20"
                >
                  <Star size={22} className="text-white" fill="white" />
                </MotionDiv>
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-widest text-[var(--accent-hex)] mb-0.5">Your Vision</p>
