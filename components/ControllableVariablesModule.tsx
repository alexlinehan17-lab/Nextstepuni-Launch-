        ...
        <>
          ...
          {(essentials ? activeSection === 2 : activeSection === 3) && (
            <ReadingSection title={essentials ? "Exercise & The Cycle." : "The Upgrade: Exercise."} eyebrow={essentials ? "Step 3" : "Step 4"} icon={Zap} theme={theme}>
                {essentials ? (
                  <>
                    <p>Exercise makes your brain better at learning. It releases <Highlight description="A protein your brain releases when you exercise. Think of it like fertiliser for your brain — it helps grow new connections and makes existing ones stronger. More of it means faster learning." theme={theme}>BDNF</Highlight>, fertiliser for your brain cells. Exercise before studying helps you focus. Exercise after studying helps you remember.</p>
                    <p>Bad sleep and bad food feed each other. Poor sleep makes you crave sugar. Sugar wrecks your deep sleep. Break the cycle from either end. Start with a decent breakfast or a consistent wake time.</p>
                  </>
                ) : (
                  <>
