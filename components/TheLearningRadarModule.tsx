        ...
        <>
          {activeSection === 0 && (
            <ReadingSection title="You Don't Know What You Don't Know." eyebrow="Step 1" icon={Target} theme={theme}>
              {essentials ? (
                <>
                  <p>Students predicted they would remember 70% of what they studied. They actually remembered 37%. Your brain consistently fools you into thinking you know more than you do.</p>
            ...
            <ReadingSection title="When to Check If You've Learned Something." eyebrow="Step 3" icon={Clock} theme={theme}>
              {essentials ? (
                <>
                  ...
                  <p>Wait 24 hours, then check yourself. After a delay, your accuracy jumps to nearly perfect. Come back tomorrow, close your notes, and see what you actually remember.</p>
                </>
              ) : (
                <>
            ...
            <ReadingSection title="The Traffic Light Audit." eyebrow="Step 4" icon={Layers} theme={theme}>
              {essentials ? (
                <>
                  ...
                  <p>Most students find their "Greens" are actually Ambers. That is uncomfortable but incredibly useful information before an exam. Testing yourself trains your brain to be more honest.</p>
                </>
              ) : (
                <>
          ...
          {activeSection === 4 && (
            <ReadingSection title="Checking Yourself During Study." eyebrow="Step 5" icon={Activity} theme={theme}>
              {essentials ? (
                <p>Build self-checking into every study session. After each section, close the book and list the key ideas from memory. If you cannot, you were reading on autopilot. Use these three checks: close the book test, make your own example test, and connect the dots test.</p>
              ) : (
                <>
            ...
            <ReadingSection title="The Prediction Game." eyebrow="Step 6" icon={Flag} theme={theme}>
              {essentials ? (
                <>
                  ...
                  <p>Students who did this improved their prediction accuracy by 50% over a year. This skill transfers across subjects too. Train it in Maths and it helps you in History.</p>
                </>
              ) : (
                <>
