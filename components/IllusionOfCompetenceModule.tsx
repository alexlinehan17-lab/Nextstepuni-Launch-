        ...
        <>
          ...
          {activeSection === 2 && (
            <ReadingSection title="The Antidote." eyebrow="Step 3" icon={Lightbulb} theme={theme}>
              {essentials ? (<>
              <p>Switch from easy study methods to hard ones. This is the idea behind <Highlight description="The idea that study methods which feel harder and slower at first actually lead to much better long-term memory. If it feels too easy, you're probably not learning much." theme={theme}>Desirable Difficulties</Highlight>: if it feels hard, you are actually learning. The best method is <Highlight description="Trying to pull information out of your memory without looking at your notes. That struggle you feel when you can't quite remember? That IS the learning happening." theme={theme}>Active Recall</Highlight>. Close your notes. Try to remember. That struggle IS learning. You are strengthening each memory every time you pull it from your head.</p>
              </>) : (<>
