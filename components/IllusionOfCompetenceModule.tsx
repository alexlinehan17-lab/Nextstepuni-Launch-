        ...
        <>
          {activeSection === 0 && (
            <ReadingSection title="The Great Deception." eyebrow="Step 1" icon={Eye} theme={theme}>
              {essentials ? (<>
              <p>The biggest study danger is the <Highlight description="That feeling where you're way more confident about a topic than you should be. You feel like you've got it nailed, but when the exam comes, it's just... gone." theme={theme}>Illusion of Competence</Highlight>. You think you know it, but you do not. Your brain confuses recognising information with being able to recall it. Seeing "Oh yeah, I know that" in your notes is not the same as pulling it from memory in an exam.<Cite n={1} /> This is the top reason people get shocked after the Mocks.</p>
              </>) : (<>
          ...
          {activeSection === 1 && (
            <ReadingSection title="The Passive Traps." eyebrow="Step 2" icon={AlertTriangle} theme={theme}>
              {essentials ? (<>
              <p>Three study habits fool you. The <Highlight description="When you re-read highlighted notes, your brain just recognises the look of the page, not the actual information. You're remembering the yellow ink, not what it says." theme={theme}>Highlighting Trap</Highlight>: you remember the yellow ink, not the content. The <Highlight description="Reading through a worked solution and nodding along feels like you could have done it yourself. But you were just a passenger — you followed someone else's thinking instead of doing your own." theme={theme}>'Solved Example' Fallacy</Highlight>: nodding along is not the same as doing it yourself. The <Highlight description="When a teacher explains something really clearly, it's easy to confuse their understanding with yours. You watched the tour, but you didn't build the house." theme={theme}>Lecture Delusion</Highlight>: a clear explanation feels like understanding, but it is the teacher's knowledge, not yours.<Cite n={2} /> Your brain forgets most new info within 24 hours unless you actively work to keep it.<Cite n={3} /></p>
              </>) : (<>
              <p>This illusion is created by the most common study methods because they're low-stress and feel effective. The first is the <Highlight description="When you re-read highlighted notes, your brain just recognises the look of the page, not the actual information. You're remembering the yellow ink, not what it says." theme={theme}>Highlighting Trap</Highlight>. The second is the <Highlight description="Reading through a worked solution and nodding along feels like you could have done it yourself. But you were just a passenger — you followed someone else's thinking instead of doing your own." theme={theme}>'Solved Example' Fallacy</Highlight>. The third is the <Highlight description="When a teacher explains something really clearly, it's easy to confuse their understanding with yours. You watched the tour, but you didn't build the house." theme={theme}>Lecture Delusion</Highlight>.<Cite n={2} /></p>
              <p>All these passive methods ignore how your memory actually works: the <Highlight description="Your brain naturally forgets most new information within 24 hours unless you actively do something to hold onto it. It's not a flaw — it's just how memory works." theme={theme}>Forgetting Curve</Highlight>.<Cite n={3} /> Passive learning feels productive, but the knowledge just slips away.</p>
              </>)}
          ...
          {activeSection === 2 && (
            <ReadingSection title="The Antidote." eyebrow="Step 3" icon={Lightbulb} theme={theme}>
              {essentials ? (<>
              <p>Switch from easy study methods to hard ones. This is the idea behind <Highlight description="The idea that study methods which feel harder and slower at first actually lead to much better long-term memory. If it feels too easy, you're probably not learning much." theme={theme}>Desirable Difficulties</Highlight>: if it feels hard, you are actually learning.<Cite n={4} /> The best method is <Highlight description="Trying to pull information out of your memory without looking at your notes. That struggle you feel when you can't quite remember? That IS the learning happening." theme={theme}>Active Recall</Highlight>. Close your notes. Try to remember. That struggle IS learning. You are strengthening each memory every time you pull it from your head.<Cite n={5} /></p>
              </>) : (<>
              <p>To break this illusion, you need to switch from study methods that feel easy (passive) to ones that feel hard (active). Here's the thing that catches everyone off guard: <Highlight description="The idea that study methods which feel harder and slower at first actually lead to much better long-term memory. If it feels too easy, you're probably not learning much." theme={theme}>Desirable Difficulties</Highlight> — the harder it feels, the more you're actually learning.<Cite n={4} /></p>
              <p>The single most powerful way to make studying harder (in a good way) is <Highlight description="Trying to pull information out of your memory without looking at your notes. That struggle you feel when you can't quite remember? That IS the learning happening." theme={theme}>Active Recall</Highlight>.<Cite n={5} /> When you force your brain to retrieve information, you're strengthening that memory for future use. The struggle is not a sign you're failing — it's the feeling of your brain getting stronger.</p>
              </>)}
            </ReadingSection>
          )}
          {activeSection === 3 && (
            <ReadingSection title="The Strategic Toolkit." eyebrow="Step 4" icon={SlidersHorizontal} theme={theme}>
              {essentials ? (<>
              <p>Pair Active Recall with two partners. <Highlight description="Spreading your study sessions out over time instead of cramming. Short sessions over several days beats one long session every time." theme={theme}>Spaced Repetition</Highlight>: spread study over days, not one long session.<Cite n={6} /> <Highlight description="Mixing different topics in the same study session instead of doing one topic for hours. It feels messier, but it trains you to tell problems apart — which is exactly what the exam demands." theme={theme}>Interleaving</Highlight>: mix topics within a session.<Cite n={7} /> Use a <Highlight description="Instead of planning what to study in advance, you log what you've already done and rate each topic Red, Amber, or Green based on how well you actually know it. Then you always start your next session with your weakest topics." theme={theme}>Retrospective Revision Timetable</Highlight>: after each session, rate topics Red, Amber, or Green. Start your next session with your weakest topics.</p>
              </>) : (<>
              <p>Active Recall is the engine, but it needs a system to work properly. The two key partners are <Highlight description="Spreading your study sessions out over time instead of cramming. Short sessions over several days beats one long session every time." theme={theme}>Spaced Repetition</Highlight><Cite n={6} /> and <Highlight description="Mixing different topics in the same study session instead of doing one topic for hours. It feels messier, but it trains you to tell problems apart — which is exactly what the exam demands." theme={theme}>Interleaving</Highlight><Cite n={7} />.</p>
          ...
          {activeSection === 4 && (
            <ReadingSection title="The Explain-It Test." eyebrow="Step 5" icon={Brain} theme={theme}>
              {essentials ? (<>
              <p>Test yourself with the <Highlight description="Try to explain a concept in simple terms, as if to a younger sibling or a friend who knows nothing about it. The moment you get stuck or fall back on big words is the moment you've found a gap in your knowledge." theme={theme}>Explain-It Technique</Highlight>. Try explaining a topic to someone who knows nothing about it. Where you stumble is where your knowledge breaks down.<Cite n={2} /> For STEM subjects, do <Highlight description="Doing exam questions under exam conditions — no notes, no textbook, no marking scheme. It forces you to face what you can actually pull from memory." theme={theme}>'Blind Practice'</Highlight>: exam questions with no notes.<Cite n={5} /> Keep a <Highlight description="A notebook where you write down every mistake, figure out why it happened (was it a careless slip, a gap in your knowledge, or a wrong idea?), and write down how to fix it." theme={theme}>Mistake Log</Highlight> to turn vague failure into specific fixes.</p>
              </>) : (<>
              ...
              <p>For STEM subjects, a practical version of this is <Highlight description="Doing exam questions under exam conditions — no notes, no textbook, no marking scheme. It forces you to face what you can actually pull from memory." theme={theme}>'Blind Practice'</Highlight><Cite n={5} /> combined with a <Highlight description="A notebook where you write down every mistake, figure out why it happened (was it a careless slip, a gap in your knowledge, or a wrong idea?), and write down how to fix it." theme={theme}>Mistake Log</Highlight>. This turns vague failure ("I'm bad at Maths") into something specific you can actually fix ("I keep forgetting the chain rule").</p>
              </>)}
              <FeynmanExplainer />
            </ReadingSection>
          )}
           {activeSection === 5 && (
            <ReadingSection title="Bulletproof Knowledge." eyebrow="Step 6" icon={Wrench} theme={theme}>
              {essentials ? (<>
              <p>Your goal is <Highlight description="Knowledge that actually holds up — and even gets stronger — when you're hit with new problems or unexpected question styles. This is what you get from active, effortful study." theme={theme}>Bulletproof Knowledge</Highlight>: understanding that holds up under pressure. Passive study gives you <Highlight description="Knowledge that only works in familiar situations. Change the wording of a question or put you under pressure, and it falls apart. This is what you get from passive study." theme={theme}>Fragile Knowledge</Highlight> that breaks when the question is worded differently. Active study builds the real thing.<Cite n={8} /> Bonus: exam anxiety drops when you genuinely know your stuff.<Cite n={9} /></p>
              </>) : (<>
              <p>The goal is to move from <Highlight description="Knowledge that only works in familiar situations. Change the wording of a question or put you under pressure, and it falls apart. This is what you get from passive study." theme={theme}>Fragile Knowledge</Highlight> to <Highlight description="Knowledge that actually holds up — and even gets stronger — when you're hit with new problems or unexpected question styles. This is what you get from active, effortful study." theme={theme}>Bulletproof Knowledge</Highlight>.<Cite n={8} /> This is the only path to real confidence.</p>
              <p>By using these harder study methods, you're not just learning better — you're also looking after your mental health. A lot of exam anxiety actually comes from a gut feeling that you don't really know the material well enough. When you've built genuine understanding through effortful practice, that anxiety fades because you know your knowledge can handle whatever the exam throws at you.<Cite n={9} /></p>
              </>)}
