      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === 'overview' && (
          ...
          >
            ...
            <div>
              ...
              <div className="space-y-1.5">
                {profile.subjects.map(sub => {
                  ...
                  return (
                    <div key={sub.subjectName} className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-zinc-900" style={{ border: '1px solid var(--outline-soft)' }}>
            ...
            {caoData && caoData.whatIfScenarios && caoData.whatIfScenarios.length > 0 && (
              <div className="rounded-xl p-4 space-y-2 bg-white dark:bg-zinc-900" style={{ border: '1px solid var(--outline-soft)' }}>
            ...
            {mockResults.length > 0 && (
              <div className="space-y-2">
                ...
                {mockResults.map((mock) => (
                  <div key={mock.id} className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-zinc-900" style={{ border: '1px solid var(--outline-soft)' }}>
        ...
        {activeTab === 'scenarios' && (
          ...
          >
            ...
            {/* Baseline strip */}
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-zinc-900" style={{ border: '1px solid var(--outline-soft)' }}>
