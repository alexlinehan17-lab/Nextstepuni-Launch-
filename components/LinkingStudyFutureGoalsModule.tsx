...
const LinkingStudyFutureGoalsModule: React.FC<{ onBack: () => void; progress: ModuleProgress; onProgressUpdate: (progress: ModuleProgress) => void }> = ({ onBack, progress, onProgressUpdate }) => {
  ...
  return (
    <ModuleLayout moduleNumber="11" moduleTitle="Linking Study to Goals" moduleSubtitle="Finding Your Why" moduleDescription={`Ever sat down to study and thought "what's the point?" This module helps you figure out why your subjects actually matter to you — and how to stay motivated when the work feels pointless.`} theme={theme} sections={sections} references={LINKING_STUDY_FUTURE_GOALS_REFERENCE_LIST} onBack={onBack} progress={progress} onProgressUpdate={onProgressUpdate} finishButtonText="Find Your Why">
      {(activeSection) => (
        <>
          {activeSection === 0 && (
            <ReadingSection title="The 'Why Bother?' Problem." eyebrow="Step 1" icon={Wind} theme={theme}>
              ...
              {essentials ? (<>
              <p>"Why bother?" is not laziness. Your brain weighs effort against purpose. This is <Highlight description="Basically, your motivation depends on two things: whether you think you can actually do the task, and whether you think it's worth doing. If either one drops, your motivation tanks." theme={theme}>Expectancy-Value Theory</Highlight>.<Cite n={1} /> When the <Highlight description="All the stuff that makes a task feel painful -- the boredom, the stress, the time it takes away from things you'd rather be doing." theme={theme}>Cost</Highlight> feels higher than the <Highlight description="How useful a subject or task feels for what you actually want to do with your life. This is the strongest type of motivation for schoolwork because it doesn't fade as fast as other kinds." theme={theme}>Utility Value</Highlight>, motivation tanks. The points race disconnects your work from real purpose. This module flips that equation.</p>
              </>) : (<>
              <p>The feeling of "why bother?" isn't laziness. It's your brain doing a quick calculation: does the effort of this task feel worth it? This idea is called <Highlight description="Basically, your motivation depends on two things: whether you think you can actually do the task, and whether you think it's worth doing. If either one drops, your motivation tanks." theme={theme}>Expectancy-Value Theory (EVT)</Highlight>.<Cite n={1} /> Motivation collapses when the <Highlight description="All the stuff that makes a task feel painful -- the boredom, the stress, the time it takes away from things you'd rather be doing." theme={theme}>Cost</Highlight> feels higher than the <Highlight description="How useful a subject or task feels for what you actually want to do with your life. This is the strongest type of motivation for schoolwork because it doesn't fade as fast as other kinds." theme={theme}>Utility Value</Highlight>.</p>
          ...
          {activeSection === 1 && (
            <ReadingSection title="The Horizon of Purpose." eyebrow="Step 2" icon={DraftingCompass} theme={theme}>
              {essentials ? (<>
              <p>Your <Highlight description="How far into the future you think when deciding what to do right now. If you're only thinking about getting to June, everything feels painful. But if you can see how today's work connects to where you want to be in 5 years, the same task starts to feel like an investment." theme={theme}>Future Time Perspective</Highlight><Cite n={2} /> is how far ahead you think. Thinking only to June makes everything painful. Thinking 5 years ahead makes the same task feel like an investment. Make it <Highlight description="A vague idea like 'I want a good life' doesn't really motivate you. What works is being specific -- like knowing exactly how learning about cell biology connects to becoming a doctor. The more concrete the link, the stronger the motivation." theme={theme}>specific</Highlight>: connect today's work to a concrete future goal.</p>
              </>) : (<>
              <p>The single biggest factor in beating the "why bother?" feeling is your <Highlight description="How far into the future you think when deciding what to do right now. If you're only thinking about getting to June, everything feels painful. But if you can see how today's work connects to where you want to be in 5 years, the same task starts to feel like an investment." theme={theme}>Future Time Perspective (FTP)</Highlight>.<Cite n={2} /> It's basically the mental timeline you use to frame what you're doing right now. A short FTP (just surviving until June) makes every task feel like a painful cost. A long FTP (seeing how this connects to your career in 5 years) reframes the exact same task as something worth doing.</p>
           ...
           {activeSection === 2 && (
            <ReadingSection title="The 'Writing Cure'." eyebrow="Step 3" icon={Wand2} theme={theme}>
              {essentials ? (<>
              <p>Do the <Highlight description="A quick writing exercise where you spend a few minutes writing about how what you're studying is actually relevant to your own life. When you put it in your own words, it stops being something a teacher told you and becomes something you actually believe." theme={theme}>Utility Value Intervention</Highlight>: write in your own words why a subject matters to you. In studies, this raised interest and grades.<Cite n={3} /> Also try <Highlight description="Spending a few minutes writing about what matters most to you -- like family, creativity, or independence. It sounds simple, but it takes the pressure off by reminding you that you're more than just your grades." theme={theme}>Self-Affirmation Journaling</Highlight>: write about what matters most to you (family, creativity). This has been shown to help buffer <Highlight description="That nagging feeling of 'people like me don't do well here.' It's the worry that you'll confirm some negative stereotype about where you're from or who you are, and it can quietly drain your performance without you even realising." theme={theme}>Stereotype Threat</Highlight> and reminds you that you are bigger than any grade.<Cite n={4} /></p>
              </>) : (<>
              <p>So how do you actually build that connection? One of the most effective exercises is the <Highlight description="A quick writing exercise where you spend a few minutes writing about how what you're studying is actually relevant to your own life. When you put it in your own words, it stops being something a teacher told you and becomes something you actually believe." theme={theme}>Utility Value Intervention</Highlight>. In a well-known study, students who wrote in their own words about how a topic was relevant to their lives became more interested and earned better grades — especially those who had been struggling.<Cite n={3} /> You go from "the teacher says this is important" to "I can actually see how this helps me."</p>
              <p>There's another writing trick that works like a mental shield: <Highlight description="Spending a few minutes writing about what matters most to you -- like family, creativity, or independence. It sounds simple, but it takes the pressure off by reminding you that you're more than just your grades." theme={theme}>Self-Affirmation Journaling</Highlight>. By spending a few minutes writing about what matters most to you -- family, creativity, helping others -- you can build a defence against <Highlight description="That nagging feeling of 'people like me don't do well here.' It's the worry that you'll confirm some negative stereotype about where you're from or who you are, and it can quietly drain your performance without you even realising." theme={theme}>Stereotype Threat</Highlight>, that nagging voice that says "people like me don't succeed here." In a landmark study, a brief values-affirmation writing exercise helped narrow the achievement gap for at-risk students<Cite n={4} /> — a reminder that who you are is so much bigger than any single exam or grade.</p>
              </>)}
           ...
           {activeSection === 3 && (
            <ReadingSection title="From Dream to Plan." eyebrow="Step 4" icon={Gamepad2} theme={theme}>
              {essentials ? (<>
              <p>Daydreaming alone can actually lower your energy.<Cite n={5} /> Use <Highlight description="Instead of just daydreaming about your ideal future, you also think honestly about the real obstacles in your way. This combo -- dream plus obstacle -- lights a fire under you because your brain goes 'oh wait, I actually need to do something about this.'" theme={theme}>Mental Contrasting</Highlight>: pair your dream with the obstacle that could block it. Then make an "If-Then" plan. "If I get distracted by my phone, then I put it in the kitchen."<Cite n={6} /> The obstacle becomes your trigger for action.</p>
              </>) : (<>
              <p>Just having a goal isn't enough. In fact, research shows pure positive daydreaming can actually <strong>lower</strong> your energy, because it tricks your brain into feeling like you've already achieved it.<Cite n={5} /> The fix is <Highlight description="Instead of just daydreaming about your ideal future, you also think honestly about the real obstacles in your way. This combo -- dream plus obstacle -- lights a fire under you because your brain goes 'oh wait, I actually need to do something about this.'" theme={theme}>Mental Contrasting</Highlight> -- deliberately pairing your dream with the internal barriers that could derail it.</p>
              <p>Here's why it works: when you think about the obstacle <strong>before</strong> it happens, your brain pre-loads a solution. "If I get distracted by my phone, then I will put it in the kitchen." These specific "if-then" plans (implementation intentions) reliably boost follow-through, turning barriers from motivation-killers into automatic triggers for action.<Cite n={6} /> The obstacle becomes the cue, not the excuse.</p>
              </>)}
              <MicroCommitment theme={theme}>
           ...
           {activeSection === 4 && (
            <ReadingSection title="Becoming the Author." eyebrow="Step 5" icon={Brain} theme={theme}>
                {essentials ? (<>
                <p><Highlight description="The idea is simple: people have three core needs to feel motivated -- feeling in control (Autonomy), feeling capable (Competence), and feeling connected to others (Relatedness). When these are met, motivation comes naturally." theme={theme}>Self-Determination Theory</Highlight> says you need <Highlight description="The feeling of being in the driver's seat. It's about doing things because you chose to, not because someone forced you." theme={theme}>Autonomy</Highlight> to feel motivated.<Cite n={7} /> Take back control with <Highlight description="Tweaking how you approach your schoolwork so it lines up with what you're actually interested in. You're not changing the assignment -- you're changing your angle on it." theme={theme}>Course Crafting</Highlight>: put your own spin on an assignment. Love art? Write your History essay about the history of art. When work feels "like you," difficulty feels worthwhile instead of crushing.<Cite n={8} /></p>
                </>) : (<>
                <p>Feeling a lack of purpose often comes from a lack of control. <Highlight description="The idea is simple: people have three core needs to feel motivated -- feeling in control (Autonomy), feeling capable (Competence), and feeling connected to others (Relatedness). When these are met, motivation comes naturally." theme={theme}>Self-Determination Theory</Highlight> tells us we're most motivated when we feel we have <Highlight description="The feeling of being in the driver's seat. It's about doing things because you chose to, not because someone forced you." theme={theme}>Autonomy</Highlight>.<Cite n={7} /> The Leaving Cert can feel like it strips that away completely.</p>
           ...
           {activeSection === 5 && (
            <ReadingSection title="Curriculum as Career Training." eyebrow="Step 6" icon={Briefcase} theme={theme}>
              {essentials ? (<>
              <p>Every subject trains real-world skills. Maths trains risk assessment. English builds communication. History builds research skills. Once you see this connection, study feels like career training, not drudgery. Check the matrix below to see how your subjects connect to careers.</p>
              </>) : (<>
          ...
          {activeSection === 6 && (
            <ReadingSection title="Hacking the System." eyebrow="Step 7" icon={GraduationCap} theme={theme}>
              {essentials ? (<>
              <p>Three schemes can help you. <Highlight description="A scheme that gives you reduced CAO points for college entry if you come from a disadvantaged background. They look at things like family income, whether your school is DEIS, and your parents' education. It can reduce the points you need for a course — the size of the reduction varies by course and college, places are limited, and you still need the minimum entry requirements." theme={theme}>HEAR</Highlight>: reduced CAO points if you come from a disadvantaged background (30-50 points off). <Highlight description="A scheme for students whose education has been affected by a disability -- whether that's physical, sensory, learning (like dyslexia or ADHD), or mental health related. You get reduced points AND extra supports in college like assistive tech and exam accommodations." theme={theme}>DARE</Highlight>: reduced points plus college supports if a disability has affected your education. <Highlight description="The main money support for going to college in Ireland. It covers your fees and gives you a grant for living costs. Big tip: if you live more than 30km from your college, you get a higher rate -- and that distance is measured to your actual course building, not just the main campus." theme={theme}>SUSI</Highlight>: covers fees and living costs. If you live over 30km from your college building, you get a higher rate. Apply through CAO in autumn of 6th year. Do not miss the deadline.</p>
              </>) : (<>
          ...
          {activeSection === 7 && (
            <ReadingSection title="The Purpose Protocol." eyebrow="Step 8" icon={Link2} theme={theme}>
              {essentials ? (<>
              <p>You have the tools. Follow the Purpose Protocol below: audit your subjects, write your vision, craft your approach, start small, and re-author your story when stuck.</p>
              </>) : (<>
