          ...
          {activeSection === 1 && (
           ...
           {activeSection === 3 && (
            <ReadingSection title="From Dream to Plan." eyebrow="Step 4" icon={Gamepad2} theme={theme}>
              {essentials ? (<>
              <p>Daydreaming alone can lower your energy. Use <Highlight description="Instead of just daydreaming about your ideal future, you also think honestly about the real obstacles in your way. This combo -- dream plus obstacle -- lights a fire under you because your brain goes 'oh wait, I actually need to do something about this.'" theme={theme}>Mental Contrasting</Highlight>: pair your dream with the obstacle that could block it. Then make an "If-Then" plan. "If I get distracted by my phone, then I put it in the kitchen." The obstacle becomes your trigger for action.</p>
              </>) : (<>
