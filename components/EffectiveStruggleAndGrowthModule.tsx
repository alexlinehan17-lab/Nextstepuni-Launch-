...
const IllusionOfCompetenceChart = () => {
    ...
    return (
        <div className="my-10 p-8 md:p-12 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700">
            ...
            <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mb-8">The gap between what *feels* effective and what *is* effective is massive.</p>
