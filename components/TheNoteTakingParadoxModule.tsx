        ...
        <>
          {activeSection === 0 && (
            <ReadingSection title="The Transcription Trap." eyebrow="Step 1" icon={FileText} theme={theme}>
              {essentials ? (
                <>
                  <p>The more notes you take, the less you learn. Students who wrote by hand scored better than those who typed everything word for word. Writing by hand forces you to pick out what matters and put it in your own words.</p>
          ...
          {activeSection === 1 && (
            <ReadingSection title="Notes That Actually Work." eyebrow="Step 2" icon={SquarePen} theme={theme}>
              {essentials ? (
                <p>Students who paraphrase and summarise outperform word-for-word note-takers by 30-40%. Real learning happens when you connect new information to what you already know. Three moves will transform your notes: summarise, give your own example, and connect to existing knowledge.</p>
              ) : (
                <>
            ...
            <ReadingSection title="The Cornell System." eyebrow="Step 3" icon={Layers} theme={theme}>
              {essentials ? (
                <>
                  ...
                  <p>Cover the right column and quiz yourself using the left column cues. This turns your notes into a built-in self-testing tool.</p>
                </>
              ) : (
                <>
          ...
          {activeSection === 3 && (
            <ReadingSection title="Mapping vs Listing." eyebrow="Step 4" icon={GitBranch} theme={theme}>
              {essentials ? (
                <>
                  <p>Concept maps beat lists when you need to understand how ideas connect. Put ideas in bubbles and draw arrows between them. This shows the big picture that lists hide.</p>
