        ...
        <>
          ...
          {activeSection === 2 && (
            <ReadingSection title="The 'Impossibility' Heuristic." eyebrow="Step 3" icon={Wand2} theme={theme}>
              <p>When does a task feel "worth doing," and when does it feel "impossible"? <Highlight description="A theory stating that we are motivated to act in ways that are congruent with our identities." theme={theme}>Identity-Based Motivation (IBM)</Highlight> theory has the answer. It's about how you interpret difficulty. When a task feels "like me," difficulty is seen as <strong>importance</strong>. ("This is hard, so it must be worth it.") When a task feels alien, difficulty is seen as <strong>impossibility</strong>. ("This is hard, so it's not for people like me.")</p>
          ...
          {activeSection === 5 && (
            <ReadingSection title="Playbook: The 'How' & 'What'." eyebrow="Step 6" icon={Link2} theme={theme}>
              ...
              <p>The "What" is about using every structural advantage available. You must conduct a <strong>HEAR & DARE Audit</strong> early in 6th year. You must become a <strong>SUSI Maximizer</strong>, checking your distance from college for the "Non-Adjacent" rate. And you must find <strong>Free "Grinds"</strong> through university access programs and high-quality YouTube channels. This is not just studying; it's system hacking.</p>
