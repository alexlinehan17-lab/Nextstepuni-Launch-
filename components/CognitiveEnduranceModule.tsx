        ...
        <>
          {activeSection === 0 && (
            <ReadingSection title="The Marathon Mindset." eyebrow="Step 1" icon={Brain} theme={theme}>
              {essentials ? (
                <>
                  ...
                  <p>Your brain builds up <Highlight description="The total stress build-up in your body and brain from weeks of pressure. When it gets too high, your thinking gets foggy and your emotions get harder to control." theme={theme}>Stress Load</Highlight> over weeks of pressure.<Cite n={2} /> You can train your brain to handle this.</p>
                </>
              ) : (
                <>
                  ...
                  <p>It's a trainable skill, not a measure of willpower. Your brain is an organ that uses around 20% of your body's energy.<Cite n={1} /> Under the constant stress of exam season, your brain builds up "wear and tear" over time — we call this <Highlight description="The total stress build-up in your body and brain from weeks of pressure. When it gets too high, your thinking gets foggy and your emotions get harder to control." theme={theme}>Stress Load</Highlight>.<Cite n={2} /> Building cognitive endurance is about training your brain to handle this build-up.</p>
                </>
              )}
           ...
           {activeSection === 1 && (
            <ReadingSection title={essentials ? "Sleep & Fuel." : "The Sleep Banking Strategy."} eyebrow="Step 2" icon={Moon} theme={theme}>
              {essentials ? (
                <>
                  <p>Sleep is your most powerful tool. Your final sleep hours are packed with <Highlight description="A special stage of sleep where your brain practises problem-solving and processes your emotions. Most of it happens in the last few hours of sleep, so if you cut your night short, this is the first thing you lose." theme={theme}>REM Sleep</Highlight> for problem-solving and emotional balance.<Cite n={3} /> Cutting sleep short skips the most important part.</p>
                  <SleepCycleArchitect />
                  <p>Your brain also runs on blood sugar. High-sugar food causes a spike-and-crash. Eat slow-burning food like porridge. Some athletes find the <Highlight description="A simple hack where you swish a sports drink around your mouth for about 10 seconds (you don't even have to swallow it). It activates reward and motor areas in the brain, which can reduce your sense of effort in exercise." theme={theme}>Sports Drink Mouth Rinse</Highlight><Cite n={4} /> helps — you could try it in the last hour of a long exam.</p>
          ...
          {!essentials && activeSection === 2 && (
            <ReadingSection title="Fueling the Engine." eyebrow="Step 3" icon={Coffee} theme={theme}>
              ...
              <p>Here's a neat trick from sports science: the <Highlight description="A simple hack where you swish a sports drink around your mouth for about 10 seconds (you don't even have to swallow it). It activates reward and motor areas in the brain, which can reduce your sense of effort." theme={theme}>Sports Drink Mouth Rinse</Highlight>. Swishing a sports drink around your mouth for about 10 seconds activates reward areas in your brain. In endurance exercise this reliably lowers how hard the effort feels;<Cite n={4} /> it may give a similar lift in the final, gruelling hour of a long exam, though the evidence for mental tasks is less settled.</p>
            </ReadingSection>
          )}
