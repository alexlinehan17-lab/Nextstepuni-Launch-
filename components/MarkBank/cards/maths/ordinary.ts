...
export const CARDS: SecCard[] = [
  ...
  } as SecCard,
  {
    ...
    paperFileid: null,
    schemeCitation: "Marking points quoted from the SEC marking scheme, Mathematics 2021 Ordinary Level — © State Examinations Commission.",
    id: "maths-2021-ol-p2-q9-a-ii", topicId: "maths-2-2", conceptId: "aircraft-starts-point-travels-250-point",
    section: "B", questionRef: "2021 OL Paper 2 Q9(a)(ii)",
    questionText: "An aircraft starts at the point S and travels 1 250 m to a point L where it lifts off. (ii) From the point L, the aircraft makes an angle of 14° with the ground, [LE]. The aeroplane travels along this path until it is directly above E. Plot and label the lift-off point L, and draw the aircraft’s flight path for this part of its journey, on the diagram above",
    tariffModel: {"kind":"fixed","notation":"Scale (0, 2, 3, 5)","answer":null,"ofParts":null,"perPart":null}, totalMarks: 5,
    rows: [
    { id: "maths-2021-ol-p2-q9-a-ii-r1", kind: "anyN", verbatim: "Work of merit Slope = rise/run A or B labelled correctly Equation of line with some correct substitution One line correctly drawn through A or B", marks: 5, contextNote: "The scheme marks this on a sliding scale: nothing for 0, one part for 2, two parts for 3, three parts for 5. Marked in order: Low Partial Credit; High Partial Credit.", openList: true, group: {"claimMax":2,"perOption":2,"options":["Work of merit Slope = rise/run A or B labelled correctly Equation of line with some correct substitution One line correctly drawn through A or B","Significant Work Both lines correctly drawn, F not identified Both equations found but not solved"],"perOptionSteps":[2,3]} },
    ],
    figure: {
  ...
  } as SecCard,
  {
    ...
    section: "B", questionRef: "2025 OL Paper 2 Q9(a)(i)",
    questionText: "On the diagram below, construct the midpoint of the side [A]. Label this point D. (If using measurements and calculations, show all calculations clearly)",
    tariffModel: {"kind":"fixed","notation":"Scale (0, 5, 10)","answer":null,"ofParts":null,"perPart":null}, totalMarks: 10,
    rows: [
    { id: "maths-2025-ol-p2-q9-a-i-r1", kind: "anyN", verbatim: "4 × 200 + 2 × 150 = 1100 m", marks: 10, contextNote: "The scheme marks this on a sliding scale: nothing for 0, one part for 5, two parts for 10. These are the lines of the scheme's own printed solution, in the order it sets them out.", openList: true, group: {"claimMax":1,"perOption":10,"options":["4 × 200 + 2 × 150 = 1100 m"]} },
    ],
    figure: {
          ...
          "alt": "The marking scheme's printed worked solution for 2025 OL Paper 2 Q9(a)(i), typeset as the State Examinations Commission set it. It reads: 4 × 200 + 2 × 150 = 1100 m",
          "attribution": "SEC Leaving Certificate Mathematics 2025 Ordinary Level — © State Examinations Commission",
          "lettersVisible": []
    },
  } as SecCard,
  ...
  } as SecCard,
  {
    ...
    section: "B", questionRef: "2025 OL Paper 2 Q9(b)(i)",
    questionText: "The longest side of the bigger table-top is 45 cm. The longest side of the smaller table-top is 36 cm",
    tariffModel: {"kind":"fixed","notation":"Scale (0, 5, 10)","answer":null,"ofParts":null,"perPart":null}, totalMarks: 10,
    rows: [
    { id: "maths-2025-ol-p2-q9-b-i-r1", kind: "anyN", verbatim: "D C F B E", marks: 10, contextNote: "The scheme marks this on a sliding scale: nothing for 0, one part for 5, two parts for 10. These are the lines of the scheme's own printed solution, in the order it sets them out.", openList: true, group: {"claimMax":2,"perOption":5,"options":["D C F B E","Or similar"]} },
    ],
    figure: {
