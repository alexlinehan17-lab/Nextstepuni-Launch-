...
export const CARDS: SecCard[] = [
  ...
  } as SecCard,
  {
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 6,
    rows: [
    { id: "r-1", kind: "anyN", verbatim: "The main benefits of a recursive approach are simplicity, elegance and conciseness // Recursion can lead to more readable and efficient algorithm descriptions. // Recursion lends itself well breaking problems down into smaller similar problems Disadvantages", marks: null, group: {"claimMax":1,"perOption":3,"options":["The main benefits of a recursive approach are simplicity, elegance and conciseness","Recursion can lead to more readable and efficient algorithm descriptions.","Recursion lends itself well breaking problems down into smaller similar problems Disadvantages"]} },
    { id: "r-2", kind: "anyN", verbatim: "Performance. Recursion can lead to slower execution time due to memory overheads // If recursion is too deep, then there is a danger of running out of space on the stack and ultimately program crashes. For each advantage/disadvantage:", marks: null, group: {"claimMax":1,"perOption":3,"options":["Performance. Recursion can lead to slower execution time due to memory overheads","If recursion is too deep, then there is a danger of running out of space on the stack and ultimately program crashes. For each advantage/disadvantage:"]} },
    ],
    figure: {
          "candId": "computer-science-2023-HL-paper-q15-fig0",
          "src": "/exam-figures/computer-science/markbank/computer-science-2023-HL-paper-q15-fig0.png",
