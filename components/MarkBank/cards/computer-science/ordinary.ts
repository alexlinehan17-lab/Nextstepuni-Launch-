...
export const CARDS: SecCard[] = [
  ...
  } as SecCard,
  {
    ...
    stem: "The image in Figure 2 depicts a client‐server model over the Internet. Provide one practical example of how a client‐server model is used in our daily interaction with technology. Figure 2",
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 5,
    rows: [
    { id: "r-1", kind: "point", verbatim: "Answer: online banking, ecommerce, Spotify, Netflix, email, online booking, school/office PC", marks: 5 },
    ],
    figure: {
  ...
  } as SecCard,
  {
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 5,
    rows: [
    { id: "r-1", kind: "point", verbatim: "- check that the email address is actually there (not left blank).", marks: 5 },
    ],
  } as SecCard,
  {
    ...base, kind: "question",
  ...
  } as SecCard,
  {
    ...
    stem: "The computational thinking skill of pattern recognition is used by machine learning algorithms to identify objects in images, such as that in Figure 1. Explain, with the use of an example, how pattern recognition might be used by such algorithms. Figure 1",
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 6,
    rows: [
    { id: "r-1", kind: "point", verbatim: "Bicycle – pattern recognition could be used to identify common characteristics of a bike such as the shape, 2 wheels, handlebars.", marks: 6 },
    ],
    figure: {
  ...
  } as SecCard,
  {
    ...
    stem: "The Central Processing Unit (CPU) is considered the most important component of the computer system. What is the role of the CPU? Figure 2",
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 6,
    rows: [
    { id: "r-1", kind: "point", verbatim: "Process data and instructions and to control the rest of the computer system", marks: 2 },
    { id: "r-2", kind: "point", verbatim: "The CPU is often compared to the brain of the computer and as such deals with all of the inputs, processes and outputs of a computer system", marks: 2 },
    { id: "r-3", kind: "point", verbatim: "The CPU processes all data on a computer system and carries out the fetch, decode, execute cycle", marks: 2 },
    ],
    figure: {
  ...
  } as SecCard,
  {
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 6,
    rows: [
    { id: "r-1", kind: "point", verbatim: "Braille keyboard - allows the user to type and enter text or instructions for the computer in Braille", marks: 6 },
    ],
  } as SecCard,
  {
    ...base, kind: "question",
  ...
  } as SecCard,
  {
    ...
    stem: "Jack has been selected as a project manager for a school project where a group are creating a student wellbeing app. List three specific tasks that a project manager would be responsible for on this project.",
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 6,
    rows: [
    { id: "r-1", kind: "point", verbatim: "Coming up with a time line / time plan", marks: 6 },
    ],
  } as SecCard,
  {
    ...base, kind: "question",
  ...
  } as SecCard,
  {
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 6,
    rows: [
    { id: "r-1", kind: "point", verbatim: "Student Name - presence check, character only", marks: 6 },
    ],
    figure: {
