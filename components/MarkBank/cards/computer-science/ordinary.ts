...
export const CARDS: SecCard[] = [
  ...
  } as SecCard,
  {
    ...
    questionText: "(a) Choose the appropriate electronic component from the list below and place it in Column B to match the correct component image in Column A. Resistor Transistor Capacitor Column A Component Image Column B Component Name (b) Select any one of these electronic components and explain its purpose.",
    tariffModel: {"kind":"fixed"}, totalMarks: 6,
    rows: [
