...
export const CARDS: SecCard[] = [
  ...
  } as SecCard,
  {
    ...
    stem: "L = [45, 22, 1, 56, 35, 165, 9, 18, 37, 21, 107, 11, 87] Will the binary search algorithm work on this list? Explain your answer.",
  ...
  } as SecCard,
  {
    ...
    stem: "Variable Name Description Data Type firstName Student’s first name String For example, the student John Doe in fifth year, with a sister in sixth year but no parental consent will fail the test.",
  ...
  } as SecCard,
  {
    ...
    stem: "Over the past year RTÉ have been looking into updating their RTÉ Player app. When a new piece of software is created for such a large organisation there are many different stages of the software development lifecycle to go through and also many different people involved.",
  ...
  } as SecCard,
  {
    ...
    stem: "Aengus Cox, RTE, 30 April 2023 Explain one risk of My AI to children if it has not been properly tested.",
