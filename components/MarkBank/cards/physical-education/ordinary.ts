...
export const CARDS: SecCard[] = [
  ...
  } as SecCard,
  {
    ...
    tariffModel: {"kind":"fixed","notation":"2 marks","answer":null,"ofParts":null,"perPart":null}, totalMarks: 2,
    rows: [
    { id: "r-1", kind: "point", verbatim: "Making links with local primary schools", marks: 2, openList: true },
    ],
  } as SecCard,
  {
    ...base, kind: "question",
  ...
  } as SecCard,
  {
    ...
    rows: [
    { id: "r-1", kind: "anyN", verbatim: "Appropriate event given", marks: 4, contextNote: "2 answers at 2 marks each, as the scheme prices it.", openList: true, group: {"claimMax":2,"perOption":2,"options":["Galway races","Irish open (Golf)","Red Bull Cliff Diving"]} },
    ],
  } as SecCard,
  {
    ...base, kind: "question",
    ...
    tariffModel: {"kind":"questionTotal"}, totalMarks: 4,
    rows: [
    { id: "r-1", kind: "point", verbatim: "Wear protective equipment eg. Helmet/shin guards", marks: null, openList: true },
    ],
  } as SecCard,
  {
    ...base, kind: "question",
