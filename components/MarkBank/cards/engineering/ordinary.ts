...
export const CARDS: SecCard[] = [
  ...
  } as SecCard,
  {
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 12,
    rows: [
    { id: "r-1", kind: "alt", verbatim: "Blast furnace", marks: 12, accepts: ["Basic oxygen furnace","Electric arc furnace"] },
    ],
  } as SecCard,
  {
    ...base, kind: "question",
  ...
  } as SecCard,
  {
    ...
    tariffModel: {"kind":"fixed"}, totalMarks: 8,
    rows: [
    { id: "r-1", kind: "alt", verbatim: "Soldering copper pipes and fittings:", marks: 8, accepts: ["Wear a suitable mask to protect from the fumes produced by the • flux."] },
    ],
  } as SecCard,
  {
    ...base, kind: "question",
