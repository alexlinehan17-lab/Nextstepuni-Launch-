        ...
        <>
          ...
          {activeSection === 3 && (
            <ReadingSection title="The Language Loop." eyebrow="Step 4" icon={BookOpen} theme={theme}>
              <p>For languages, your "stand-in teacher" is a correct text in the language you're learning. The technique is <Highlight description="You translate a passage from Irish (or French, etc.) into English, wait a while, then translate your English version back without looking at the original. Then you compare the two versions side by side to spot your mistakes." theme={theme}>Back-Translation</Highlight>. You take a short passage in Irish (or French, etc.), translate it into English, wait an hour, then translate your English version *back* into the original language without looking at it. Finally, you compare your version with the original, side by side.</p>
