...
export default function DesktopSetup(props: OnboardingProps) {
  const {
    ...
    updateBulkGrade,
    deferUnfilledGrades,
  } = useSetupFlow(props, true);
  return (
    <div
      className="setup-flow desk-flow"
    ...
    >
      ...
      >
        <div className="setup-shell">
          ...
          <main
            className="setup-content desk-main"
            data-bulk-grades={bulkGrades}
          ...
          >
            {bulkGrades ? (
              <GradeOptions
                ...
                layout="sheet"
                headingRef={heading}
                onUpdate={updateBulkGrade}
                onDefer={deferUnfilledGrades}
              />
            ) : (
              <>
                <section className="desk-story">
                  <p className="setup-eyebrow">{intro}</p>
                  <h1
                    ref={heading}
                    tabIndex={-1}
                    className={
                      draft.step === "welcome" ? "setup-welcome-title" : ""
                    }
                  >
                    {title}
                  </h1>
                  ...
                  {draft.step === "welcome" && (
                    <>
                      <p className="desk-welcome-lead">
                        A little more direction.
                        <br />A lot more possibility.
                      </p>
                      <p className="desk-introduction">
                        Choose what matters to you, add your subjects, and make
                  ...
                  {draft.step === "year" && (
                    <>
                      ...
                      <img
                        className="desk-story-art desk-person"
                  ...
                  {draft.step === "north" && (
                    <>
                      <p className="desk-introduction">
                        Everyone has a reason for putting in the work.
                        <br />
                        What’s yours?
                      </p>
                      <NorthStarArtwork
                        ...
                        label={category?.label ?? "Find your direction"}
                        reduced={reduced}
                      />
                    </>
                  )}
                  {draft.step === "vision" && (
                    <>
                      <p className="desk-introduction">
                        Choose 1–{maxVision} things you’d love to make happen.
                        One is enough to start.
                      </p>
                      <div className="desk-vision-count">
                        <strong>
                          {draft.vision.length.toString().padStart(2, "0")}
                        </strong>
                        <span>
                          ideas
                          <br />
                      ...
                      <div className="desk-chosen-ideas">
                        {visions
                  ...
                  {draft.step === "subjects" && (
                    <>
                      <p className="desk-introduction">
                        Your subjects. Your starting point.
                        <br />
                        Choose the ones you take now.
                      </p>
                      <div className="desk-subject-art">
                        <img src="/icons/onboarding/subjects.png" alt="" />
                        <div>
                          <strong>
                            {draft.subjects.length.toString().padStart(2, "0")}
                          </strong>
                          <span>subjects selected</span>
                        </div>
                      </div>
                      <div className="desk-chosen-subjects">
                  ...
                  {draft.step === "grades" && (
                    <>
                      ...
                      <div
                        className="desk-grade-graphic"
                        aria-label="Current and target grades"
                      >
                        {(["current", "target"] as const).map((field) => {
                          const index = gradeChoices.indexOf(config[field]);
                          return (
                            <div key={field}>
                              <div className="desk-grade-track">
                                <div
                                  data-target={field === "target"}
                                  style={{
                                    height: `${index < 0 ? 0 : Math.max(10, ((gradeChoices.length - index) / gradeChoices.length) * 100)}%`,
                                  }}
                                />
                              </div>
                              <strong>
                  ...
                  {draft.step === "schedule" && (
                    <>
                      ...
                      {needsDate(draft.year) && daysUntil(draft.date) > 0 ? (
                        <div className="desk-countdown">
                        ...
                        <img
                          ...
                          src="/icons/onboarding/countdown.png"
                          alt=""
                        />
                      )}
                    </>
                  ...
                  {draft.step === "summary" && (
                    <>
                      <p className="desk-introduction">
                        ...
                        <br />
                        See what you’ve set in motion.
                      </p>
                      {!junior && !lca && (
                        <section className="desk-points">
                          ...
                          <p>
                            Based on{" "}
                            {points.count > 6
                              ? `the best six of ${points.count}`
                              : points.count}{" "}
                            subjects with grades set.
                          </p>
                        </section>
                      )}
                      <p className="desk-ready-note">
                        Small steps.
                        <br />
                ...
                <section className="desk-choices" aria-label="Your choices">
                  {draft.step === "welcome" && (
                    <figure className="desk-welcome-figure">
                      <img
                        src="/icons/onboarding/north-star.png"
                        alt="Hand-drawn North Star"
                      />
                      <figcaption>
                        <span className="desk-figure-kicker">
                          Your next chapter
                        </span>
                        Starts with
                        <br />
                    ...
                    <>
                      <label className="setup-field">
                        ...
                        <select
                          ...
                          onChange={(event) =>
                            setVisionGroup(event.target.value)
                          }
                        >
                          {categories.map((item) => (
