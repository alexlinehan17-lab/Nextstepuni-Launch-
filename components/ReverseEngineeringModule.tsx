...
import { REVERSE_ENGINEERING_REFERENCE_LIST } from '../data/references/reverseEngineering';
        ...
        <>
          {activeSection === 0 && (
            <ReadingSection title="Why Most Study Plans Fail." eyebrow="Step 1" icon={History} theme={theme}>
              {essentials ? (
                <>
                  <p>Planning forward feels obvious. It is also why most plans fail. You fall into the <Highlight description="We are naturally bad at guessing how long things take. We picture the best-case scenario and forget about sick days, tiredness, and life getting in the way." theme={theme}>Planning Fallacy</Highlight>.<Cite n={1} /> You underestimate how long things take. Everything piles up at the end. The fix: use <Highlight description="Instead of planning from today forward, you start at your exam date and work backwards to today. It forces you to face how much time you really have." theme={theme}>Reverse Engineering</Highlight>. Start from your exam date and work backwards. It forces you to face reality from day one.</p>
                </>
              ) : (
                <>
                  <p>Starting at the beginning and working forward seems like the obvious way to plan. It is also the main reason most study plans fall apart. The problem is the <Highlight description="We are naturally bad at guessing how long things take. We picture the best-case scenario and forget about sick days, tiredness, and life getting in the way." theme={theme}>Planning Fallacy</Highlight><Cite n={1} /> -- we are terrible at guessing how long things will really take. We forget about sick days, tiredness, and just life getting in the way. So everything piles up at the end, and you are left cramming the week before.</p>
          ...
          {activeSection === 2 && (
            <ReadingSection title="Breaking Down the Syllabus." eyebrow="Step 3" icon={ClipboardList} theme={theme}>
              {essentials ? (
                ...
                <>
                  ...
                  <p>Next, do a full <Highlight description="Go through every topic on the syllabus and break it into small chunks, each about one study session long (45-90 minutes)." theme={theme}>Syllabus Breakdown</Highlight>. Go through every topic and break it into bite-sized chunks, each about one study session long. "Cell Biology" is too vague -- break it into "Mitochondria," "Osmosis," and so on. Then use past papers to figure out the <Highlight description="Some topics come up far more often than others — weight your time towards them first, but still cover the whole syllabus, because the SEC guarantees no topic." theme={theme}>high-frequency topics</Highlight>: some topics come up far more often than others. Those are the ones you hit first — while still covering everything.</p>
                  <PersonalStory name="Caoimhe" role="Senior cycle, Limerick" junior={{ name: 'Caoimhe', role: '3rd Year, Limerick', children: (
                    <p>"I had this massive colour-coded timetable on my wall and felt so organised. A few weeks later it was already in the bin. I was behind on everything and it just made me feel worse. When I tried planning backwards from my exam instead, I actually finished a topic ahead of schedule for the first time. It was such a relief to have a plan that worked with real life, not against it."</p>
                  ) }}>
           ...
           {activeSection === 4 && (
            <ReadingSection title="Studying Smarter." eyebrow="Step 5" icon={BrainCircuit} theme={theme}>
              {essentials ? (
                <>
                  <p>Plan how you study, not just what you study. Use <Highlight description="Instead of cramming everything once, you go back and review old topics at growing intervals. It is the best way to stop yourself forgetting things." theme={theme}>Spaced Repetition</Highlight>. Go back to old topics at regular intervals.<Cite n={3} /> Use <Highlight description="Testing yourself -- writing answers, doing practice questions -- rather than just re-reading your notes. It feels harder but it is far more effective." theme={theme}>Active Recall</Highlight>. Test yourself instead of re-reading.<Cite n={4} /> Try <Highlight description="Mixing different topics in one study session instead of doing hours on the same thing. It feels messier but it trains your brain to spot which method to use -- exactly what exams test." theme={theme}>Mixing Topics</Highlight> in later phases. Study different subjects in one session. It feels harder but trains flexible thinking.<Cite n={5} /></p>
                </>
              ) : (
                <>
                  ...
                  <p>You should also prioritise <Highlight description="Testing yourself -- writing answers, doing practice questions -- rather than just re-reading your notes. It feels harder but it is far more effective." theme={theme}>Active Recall</Highlight> (testing yourself, writing answers) over passive re-reading.<Cite n={4} /> And in the later phases, try <Highlight description="Mixing different topics in one study session instead of doing hours on the same thing. It feels messier but it trains your brain to spot which method to use -- exactly what exams test." theme={theme}>Mixing Topics</Highlight> -- studying different subjects in one session. It feels harder, but it trains your brain to spot which approach to use, which is exactly what exam questions test.<Cite n={5} /></p>
                </>
              )}
            </ReadingSection>
          )}
