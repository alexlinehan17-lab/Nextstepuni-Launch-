...
// Re-export shared auth utilities from canonical location
export { type SessionUser, AVATAR_SEEDS, getAvatarUrl, getAvatarFallback, handleAvatarError } from '../utils/authUtils';
