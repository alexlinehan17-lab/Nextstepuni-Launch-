        ...
        <>
          {activeSection === 0 && (
            <ReadingSection title="The Time Trap." eyebrow="Step 1" icon={Target} theme={theme}>
              {essentials ? (
                <>
                  <p>Stop counting hours. Start counting results. Sitting at a desk for five hours means nothing if you learned nothing — that "yeah, I know this" feeling you get from re-reading is often an <Highlight description="That feeling when you read your notes and think 'yeah, I know this' -- but then you can't actually answer the question in the exam. Recognising something is not the same as knowing it." theme={theme}>Illusion of Competence</Highlight>, not real knowledge.<Cite n={1} /> Ditch <Highlight description="Stuff like re-reading your notes or highlighting everything -- it feels productive but barely sticks. You're just going through the motions." theme={theme}>Naive Practice</Highlight> like re-reading notes. Switch to <Highlight description="Focused practice where you work on the specific things you're weak at and get feedback straight away. It's harder, but it's how you actually improve." theme={theme}>Deliberate Practice</Highlight>.<Cite n={2} /> That means working on your weak spots and getting feedback. Write a paragraph and compare it to a H1 answer. That is real progress.</p>
                </>
              ) : (
                <>
