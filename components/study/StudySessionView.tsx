    ...
    return (
      <div className="ss-completion-view min-h-screen bg-white dark:bg-zinc-950 flex flex-col items-center justify-center px-4 py-12">
        <MotionDiv
          ...
          className="ss-completion-panel w-full max-w-lg space-y-6 rounded-[24px] border-[1.5px] border-[#383838] bg-white p-6 shadow-[5px_5px_0_0_#383838] sm:p-8 dark:border-zinc-600 dark:bg-zinc-900"
        >
