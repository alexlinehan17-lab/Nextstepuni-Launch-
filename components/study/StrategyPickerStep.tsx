...
const StrategyPickerStep: React.FC<StrategyPickerStepProps> = ({
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex flex-col items-center justify-center px-4 pt-10 pb-[calc(105px+env(safe-area-inset-bottom))] md:pb-10">
      <MotionDiv
