...
const LoginPage: React.FC<LoginPageProps> = ({ handleLoginSuccess }) => {
  const mobileAppDesign = useMobileAppDesign();
  // ── Top-level mode ──
  const [view, setView] = useState<'welcome' | 'login' | 'register' | 'gc' | 'staff' | 'forgot'>(() => mobileAppDesign ? 'login' : 'welcome');
...
<div className="account-welcome">
              ...
              <button type="button" onClick={() => setSchoolAccessOpen(true)} className="mt-4 flex min-h-12 items-center justify-between border-t border-black/25 text-sm font-semibold">School access<ArrowRight size={17} aria-hidden="true" /></button>
...
<>
          ...
          {view === 'gc' && (
            <>
              ...
              {mobileAppDesign ? <h1 className="account-title mb-1 text-3xl font-semibold tracking-tight md:text-2xl" style={{ fontFamily: "'Source Serif 4', serif", color: '#1a1a1a' }}>Guidance Counsellor</h1> : <h2 className="mb-1 text-3xl font-semibold tracking-tight md:text-2xl" style={{ fontFamily: "'Source Serif 4', serif", color: '#1a1a1a' }}>Guidance Counsellor</h2>}
          ...
          {view === 'staff' && (
            <>
              ...
              {mobileAppDesign ? <h1 className="account-title mb-1 text-3xl font-semibold tracking-tight md:text-2xl" style={{ fontFamily: "'Source Serif 4', serif", color: '#1a1a1a' }}>Teacher / staff access</h1> : <h2 className="mb-1 text-3xl font-semibold tracking-tight md:text-2xl" style={{ fontFamily: "'Source Serif 4', serif", color: '#1a1a1a' }}>Teacher / staff access</h2>}
