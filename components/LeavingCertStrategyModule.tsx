        ...
        <>
          {activeSection === 0 && (
            <ReadingSection title="How the Points Game Works." eyebrow="Step 1" icon={Calculator} theme={theme}>
              ...
              <p>There are three rules you absolutely need to know.<Cite n={1} /> Get your head around these three things and you're already ahead of most students.</p>
              </>)}
              <ConceptCardGrid
                cards={[
          ...
          {activeSection === 2 && (
           ...
           {activeSection === 3 && (
            <ReadingSection title="Your Other Subjects." eyebrow="Step 4" icon={PenSquare} theme={theme}>
              ...
              <p>For Business, <Highlight description="Long questions in Business follow a pattern: State your point, Explain what it means, then give an Example. Stick to this and you'll pick up marks consistently." theme={theme}>structure is everything</Highlight> -- follow the "State, Explain, Example" format and you'll pick up marks every time. These aren't just tips; they're how the marking schemes actually work<Cite n={2} /> — and examiner reports repeatedly note that brief one-word answers lose marks on questions that need developed points.<Cite n={3} /></p>
              </>)}
            </ReadingSection>
          )}
           {activeSection === 4 && (
