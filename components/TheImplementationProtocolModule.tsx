        ...
        <>
            ...
            <ReadingSection title="The Intention-Action Gap." eyebrow="Step 1" icon={Target} theme={theme}>
              {essentials ? (
                ...
                <>
                  ...
                  <p><Highlight description="This gap gets even worse when the thing you need to do requires effort over a long time. A one-off task? Not so bad. But something like a six-month study plan for big exams? That's where the gap is at its widest." theme={theme}>Here's the kicker</Highlight>: this gap is especially large for goals that need sustained effort over time -- like prepping for your big exams. It's one thing to feel motivated on a Sunday evening when you're planning your week. It's another thing entirely to sit down at 4pm on a rainy Tuesday and actually open your textbook. Motivation is a feeling. Action is a behaviour. And the bridge between them is not willpower -- it's something far more specific.</p>
                </>
              )}
          ...
          {activeSection === 1 && (
            <ReadingSection title="If-Then Plans." eyebrow="Step 2" icon={GitBranch} theme={theme}>
              {essentials ? (
                <>
                  <p>Here is what to do: make specific <strong>"if-then" plans</strong>.<Cite n={2} /> "If it is 4pm on Monday, then I will do 25 minutes of Maths past papers." This format roughly doubled follow-through across 94 studies.<Cite n={3} /></p>
