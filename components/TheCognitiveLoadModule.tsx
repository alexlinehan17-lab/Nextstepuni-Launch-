        ...
        <>
            ...
            <ReadingSection title="The Bottleneck." eyebrow="Step 1" icon={Cpu} theme={theme}>
              {essentials ? (
                ...
                <>
                  ...
                  <PersonalStory name="Niamh" role="6th Year, Galway" junior={{ name: 'Niamh', role: '3rd Year, Galway', children: (
                    <p>I used to sit down with my Science textbook and read the same chapter three or four times. I'd highlight loads, and it felt like I was really getting it. Then I'd go into a test and just... blank. It was so frustrating. Once I learned that my brain can only hold about 4 things at a time, I stopped trying to take in a whole chapter at once. I break it into small chunks now, and I actually test myself after each one. It's slower, but I actually remember things when it counts.</p>
                  ) }}>
          ...
          {activeSection === 1 && (
            <ReadingSection title="Three Kinds of Brain Drain." eyebrow="Step 2" icon={SlidersHorizontal} theme={theme}>
              {essentials ? (
                <p>Three types of mental load compete for your brain's 4 slots.<Cite n={4} /> <strong>Built-in difficulty</strong> is how hard the topic naturally is. <strong>Wasted effort</strong> is brainpower lost to distractions. <strong>Actual learning effort</strong> is what builds real understanding. Cut the waste so you have room for real learning.</p>
              ) : (
                <p>Researchers figured out that there are three types of mental load that compete for your brain's limited capacity.<Cite n={4} /> Understanding these three types is the key to making every study session count.</p>
              )}
              <ConceptCardGrid
                cards={[
          ...
          {activeSection === 2 && (
            <ReadingSection title="Why Separate Diagrams Kill Learning." eyebrow="Step 3" icon={AlertTriangle} theme={theme}>
              {essentials ? (
                <>
                  <p>When a diagram is on one part of the page and the explanation is somewhere else, your brain wastes energy jumping between them. This is called <strong>split attention</strong>.<Cite n={5} /></p>
                  <p>Here is what to do: write notes directly onto diagrams. Put visuals and explanations together on flashcards. Students who used combined materials learned substantially better.<Cite n={5} /> Keep related information in one place.</p>
                </>
              ) : (
                <>
                  <p>One of the sneakiest ways your brain gets overloaded is something called <Highlight description="This happens when a diagram is on one part of the page and the explanation is somewhere else. Your brain wastes energy jumping back and forth instead of actually learning." theme={theme}>split attention</Highlight>.<Cite n={5} /> When a diagram and its explanation are in different places — text at the bottom of the page, diagram at the top — your brain has to mentally stitch them together. That stitching process eats up brainpower that should be going towards actually understanding the content.</p>
                  <p>The research is clear: <Highlight description="Putting labels and explanations directly on the diagram means your brain doesn't have to jump around the page. Studies show this leads to substantially better learning." theme={theme}>putting everything together</Highlight> (labels placed directly on diagrams) substantially outperforms having things separated.<Cite n={5} /> Students who studied with combined materials learned more than those who studied the same content with the text and images apart. This isn't a small difference; it's a game-changer.</p>
          ...
          {activeSection === 3 && (
            <ReadingSection title="When Easy Becomes Harmful." eyebrow="Step 4" icon={Activity} theme={theme}>
              {essentials ? (
                <>
                  <p>Study techniques that help beginners can hurt you once you improve.<Cite n={6} /> Worked examples are great when you are starting out. But once you know the method, they waste your brainpower.</p>
                ...
                <>
                  <p>Here's something that surprises most people: study techniques that help beginners can actually <em>hurt</em> you once you get better at a topic. This <Highlight description="What helps you when you're new to a topic can actually slow you down once you've got the basics. Your brain starts wasting energy on stuff it already knows." theme={theme}>plot twist</Highlight><Cite n={6} /> fundamentally changes how you should think about study methods.</p>
